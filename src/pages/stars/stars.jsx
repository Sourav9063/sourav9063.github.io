...
export default function Stars() {
    ...
    const [word, setWord] = useState(listOfWords[Math.floor(Math.random() * listOfWords.length)]);
    ...
    return (
        <div className={`${style.beforeZ} text_not_selectable`}>
                        ...
                        return (
                            <div
                                ...
                                style={{
                                    ...
                                    // opacity: 0,
                                    opacity: distance(x, y, star.left, star.top) < (ratio >= 1 ? distConst / ratio : distConst * ratio) ? 1 : star.opacity,
            ...
            <div className={style.word}><div>{word}</div></div>
            <div className={style.light} style={{ "--x": x + "%", "--y": y + "%" }}>
