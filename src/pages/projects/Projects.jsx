    ...
    <div className={`${style.body}`}>
      ...
      >
        ...
        <div
          ...
          style={{
            transform: `translateY(${-1.4 * scrollPosition}px) rotate(-10deg)`,
          }}
        >
          <img
            alt="uBookSharing"
        ...
        >
          ...
          <img alt="Ftp Nextron" src={projectsData["FTP Searcher"].images[0]} />
        </div>
        <div
        ...
        >
          <div className={style.title}>FTP Nextron</div>
          <img alt="Ftp Nextron" src={projectsData["FTP Searcher"].images[2]} />
        </div>
        {/* Hungry Camper */}
        <div
