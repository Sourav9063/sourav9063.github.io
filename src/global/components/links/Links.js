    ...
    return (
        <div orientation="left" className={`${style.links}`}>
            <ul >
                ...
                <li><a href="https://github.com/Sourav9063" aria-label="GitHub" target="_blank" rel="noreferrer"><svg stroke="currentColor" xmlns="http://www.w3.org/2000/svg" role="img" viewBox="0 0 24 24" fill="none" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><title>GitHub</title><path d="M9 19c-5 1.5-5-2.5-7-3m14 6v-3.87a3.37 3.37 0 0 0-.94-2.61c3.14-.35 6.44-1.54 6.44-7A5.44 5.44 0 0 0 20 4.77 5.07 5.07 0 0 0 19.91 1S18.73.65 16 2.48a13.38 13.38 0 0 0-7 0C6.27.65 5.09 1 5.09 1A5.07 5.07 0 0 0 5 4.77a5.44 5.44 0 0 0-1.5 3.78c0 5.42 3.3 6.61 6.44 7A3.37 3.37 0 0 0 9 18.13V22"></path></svg></a></li>
                <li><a href="https://www.facebook.com/Sourav.Ahmed63/" aria-label="FaceBook" target="_blank" rel="noreferrer">
                ...
                <li><a href="https://www.instagram.com/souravahmed9861" aria-label="Instagram" target="_blank" rel="noreferrer"><svg stroke="currentColor" width="25" height="25" viewBox="0 0 25 25" fill="none" xmlns="http://www.w3.org/2000/svg">
                ...
                <li><a href="https://twitter.com/SouravA89184178" aria-label="Twitter" target="_blank" rel="noreferrer"><svg stroke="currentColor" xmlns="http://www.w3.org/2000/svg" role="img" viewBox="0 0 24 24" fill="none" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" ><title>Twitter</title><path d="M23 3a10.9 10.9 0 0 1-3.14 1.53 4.48 4.48 0 0 0-7.86 3v1A10.66 10.66 0 0 1 3 4s-4 9 5 13a11.64 11.64 0 0 1-7 2c9 5 20 0 20-11.5a4.5 4.5 0 0 0-.08-.83A7.72 7.72 0 0 0 23 3z"></path></svg></a></li>
                <li><a href="https://www.linkedin.com/in/sourav-ahmed/" aria-label="Linkedin" target="_blank" rel="noreferrer"><svg stroke="currentColor" width="26" height="26" viewBox="0 0 26 26" fill="none" xmlns="http://www.w3.org/2000/svg">
