...
export default function Links() {
    ...
    const funcMouseLeave = (i) => {
        paths[i].animate(
            { strokeDashoffset: paths[i].getTotalLength() - (paths[i].getTotalLength() * 1) },
            {
                duration: 500,
    ...
    const funcMouseEnter = (i) => {
        ...
        paths[i].animate(
            { strokeDashoffset: paths[i].getTotalLength() - (paths[i].getTotalLength() * 3) },
            {
                duration: 1200,
    ...
    return (
        ...
        <div div orientation="left" className={`${style.links}`
        }>
            <ul >
                <li>
